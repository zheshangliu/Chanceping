/**
 * 盯机会 ChancePing 品牌常量（单一来源）
 *
 * 全项目产品名、Slogan、CTA 必须从此文件引用，不得在其它代码中硬编码。
 * 取值来源：《盯机会 ChancePing V0.12 品牌统一规范》（05 号文档）。
 */
export const BRAND = {
  /** 产品正式名称 */
  product_name: "盯机会 ChancePing",
  /** 产品类型 */
  product_category: "AI 机会雷达系统",
  /** 中文 Slogan */
  chinese_slogan: "盯机会，好机会不错过。",
  /** 备用中文 Slogan */
  alternate_chinese_slogan: "盯机会，机会就来了。",
  /** 英文 Slogan */
 ...
 * 取自 03 号文档第 11 节：report_title_prefix = "盯机会 ChancePing｜"
 */
...
/** 获取指定 locale 的报告标题前缀（如 "盯机会 ChancePing｜" 或 "ChancePing｜"） */
